...
def list_algorithms():
    ...
    Returns:
        JSON with algorithms array containing metadata
    """
    try:
        algorithms = registry.list_all()
        return jsonify(
            {"success": True, "algorithms": algorithms, "count": len(algorithms)}
        )
...
def get_algorithm_info(algorithm_id):
    ...
    try:
        ...
        return jsonify({"success": True, "algorithm": algorithm.metadata})
...
def generate_trace(algorithm_id):
    ...
    Request Body:
        JSON with algorithm-specific input data

    Returns:
        JSON with trace and result
    """
    try:
        algorithm = registry.get(algorithm_id)
        ...
        return jsonify({"success": True, "trace": trace, "result": result})
